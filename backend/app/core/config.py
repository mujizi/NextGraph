...
class Settings(BaseSettings):
    ...
    milvus_db: str = Field(default="nextGraph", description="Milvus database name.")
    ...
    passages_collection: str = Field(default="passages", description="Passage collection name.")
